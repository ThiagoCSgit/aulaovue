...
import ComDadosReativosPrimitivos from "./components/ComDadosReativosNaoPrimitivos.vue";
...
<template>
  <div>
    ...
    <RenderizacaoListas nome="Thiago" :cachorros="meuscachorros" />
    <RenderizacaoCondicional nome="Thiago" :quant-caes="2" />
    <PropriedadesAssistidas />
    <PropriedadesComputadas />
    <EscutaEvento />
    <ComProps item="Caderno" :preco="10.5" />
    <DataBinding />
